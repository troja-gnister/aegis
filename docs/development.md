...
The first work package is [2A.1 indexed browsing](superpowers/specs/2026-09-14-phase-2a-indexed-browser-design.md). Its [implementation plan](superpowers/plans/2026-09-14-phase-2a-indexed-browser.md) defines 18 tasks: one completed and 17 remaining. Task 1 supplies the filename domain and focused verification commands below; its reviewed revision `104208f` passed 673 backend tests. Other planned modules and commands are not available until their tasks land. No browsing API, screen or Phase 2 benchmark result is claimed yet.
