...
AEGIS_PUBLIC_URL = RUNTIME_CONFIG.public_url
...
AEGIS_WORKER_HEARTBEAT_RETENTION_SECONDS = (
    WORKER_RUNTIME_CONFIG.heartbeat_retention_seconds
)
AEGIS_WORKER_HEARTBEAT_SLOTS_PER_ROLE = WORKER_RUNTIME_CONFIG.heartbeat_slots_per_role
...
MIDDLEWARE = [
    ...
    "aegis_apps.roots.middleware.RootCatalogCacheControlMiddleware",
